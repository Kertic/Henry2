...
using Henry2Mod.Survivors.Henry.Components;
...
{
    public class Henry2Survivor : SurvivorBase<Henry2Survivor>
    {
        public delegate void OnHitDelegate(object sender, EventArgs e);
        public event OnHitDelegate OnSlashHit;
        ...
        public const string HENRY_PREFIX = Henry2Plugin.DEVELOPER_PREFIX + "_HENRY2_";
        ...
        public override UnlockableDef characterUnlockableDef => Henry2Unlockables.characterUnlockableDef;

        public override ItemDisplaysBase itemDisplays => new Henry2ItemDisplays();
        ...
        private SkillDef m_specialSkill;
        ...
        public override void InitializeCharacter()
        {
            ...
            Henry2Assets.Init(assetBundle);
            Henry2Buffs.Init(assetBundle);
        ...
        {
            AddHitboxes();
            bodyPrefab.AddComponent<Henry2WeaponComponent>();
        ...
        private void AddSecondarySkills()
        {
            ...
            m_secondarySkill = Skills.CreateSkillDef(new SkillDefInfo
            {
                skillName = "HenryGun",
